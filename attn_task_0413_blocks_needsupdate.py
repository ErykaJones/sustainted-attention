...
######this file is NOT up to date. This is just to test the blocks! 
...
textBreak = visual.TextStim(win, text = 'Take a break now. Blink if needed.', pos = (0.0,0.0))
